...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_event', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='creator', to=orm['auth.User']),
                      keep_default=False)

        # Adding M2M table for field administrators on 'Event'
        db.create_table('events_event_administrators', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['events.event'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('events_event_administrators', ['event_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field administrators on 'Event'
        db.delete_table('events_event_administrators')
    ...
    models = {
        ...
        'events.event': {
            ...
            'administrators': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'symmetrical': 'False'}),
