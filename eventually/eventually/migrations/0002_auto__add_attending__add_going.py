...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('eventually_attending', (
        ...
        db.send_create_signal('eventually', ['Attending'])

        # Adding model 'Going'
        db.create_table('eventually_going', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eventually.UserProfile'])),
        ...
        db.send_create_signal('eventually', ['Going'])

        # Removing M2M table for field sessions on 'UserProfile'
        db.delete_table('eventually_userprofile_sessions')


    def backwards(self, orm):
        # Deleting model 'Attending'
        db.delete_table('eventually_attending')

        # Deleting model 'Going'
        db.delete_table('eventually_going')

        # Adding M2M table for field sessions on 'UserProfile'
        db.create_table('eventually_userprofile_sessions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['eventually.userprofile'], null=False)),
            ('session', models.ForeignKey(orm['events.session'], null=False))
        ))
        db.create_unique('eventually_userprofile_sessions', ['userprofile_id', 'session_id'])
    ...
    models = {
        ...
        'eventually.userprofile': {
            ...
            'events': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['events.Event']", 'through': "orm['eventually.Going']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sessions': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['events.Session']", 'through': "orm['eventually.Attending']", 'symmetrical': 'False'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True'})
        }
    }

    complete_apps = ['eventually']